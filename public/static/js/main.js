...
$(document).ready(function () {
	...
	$(document).on('click', '.vig-items-item-second-col .number-increment', function(e) {
		...
		$(this).closest(".vig-items-item-second-col").find(".number-result").text($input.val()+ " шт.");
    });
    $(document).on('click', '.vig-items-item-second-col .number-decrement', function(e) {
        let $input = $(this).siblings('.number-input'),
            val = parseInt($input.val()),
	...
	$(document).on('click', '.top-items-item-second-col .number-increment', function(e) {
        let $input = $(this).siblings('.number-input'),
            val = parseInt($input.val()),
            max = parseInt($input.attr('max')),
            step = parseInt($input.attr('step'));
		let temp = val + step;
		$input.val(temp <= max ? temp : max);
		$(this).closest(".top-items-item-second-col").find(".number-result").text($input.val()+ " шт.");
    });
    $(document).on('click', '.top-items-item-second-col .number-decrement', function(e) {
        let $input = $(this).siblings('.number-input'),
            val = parseInt($input.val()),
            min = parseInt($input.attr('min')),
            step = parseInt($input.attr('step'));
	...
	$(document).on('click', '.new-items-item-second-col .number-increment', function(e) {
        let $input = $(this).siblings('.number-input'),
            val = parseInt($input.val()),
            max = parseInt($input.attr('max')),
            step = parseInt($input.attr('step'));
		let temp = val + step;
		$input.val(temp <= max ? temp : max);
		$(this).closest(".new-items-item-second-col").find(".number-result").text($input.val()+ " шт.");
    });
    $(document).on('click', '.new-items-item-second-col .number-decrement', function(e) {
        let $input = $(this).siblings('.number-input'),
            val = parseInt($input.val()),
            min = parseInt($input.attr('min')),
            step = parseInt($input.attr('step'));
